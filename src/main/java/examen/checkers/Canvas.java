...
public class Canvas {
    ...
    public static Canvas getCanvas() {
        if (canvasSingleton == null) {
            canvasSingleton = new Canvas("Canvas: Collage", 720, 720,
                    Color.black);
        }
    ...
    public void setForegroundColor(String colorString) {
        if (colorString.equals("red") || colorString.equals("rojo")) {
            graphic.setColor(new Color(224, 81, 96));
        } else if (colorString.equals("black") || colorString.equals("negro")) {
            graphic.setColor(new Color(0, 8, 77));
            ...
            graphic.setColor(new Color(255, 127, 0));
        } else if (colorString.equals("custom")) {
            graphic.setColor(new Color(154, 50, 98));
        } else if (colorString.equals("magenta") || colorString.equals("morado")) {
